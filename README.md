...
If you end up using this library for research purpose, please consider citing one of the following papers:

```
Dragonfly, a modular deep reinforcement learning library
J. Viquerat, P. Garnier, A. Bateni, E. Hachem
arXiv pre-print 2505.03778, 2025 (<a href="https://arxiv.org/abs/2505.03778">link</a>)
```

```
Parallel bootstrap-based on-policy deep reinforcement learning for continuous fluid flow control applications
J. Viquerat, E. Hachem
Fluids, vol. 8, iss. 7, 2023 (<a href="https://www.mdpi.com/2311-5521/8/7/208">link</a>)
```
