...
class Agent:
    ...
    def _build_actor_network(self):
        ...
        init_1  = K.initializers.Orthogonal(gain=0.5, seed=None)
        init_2  = K.initializers.Orthogonal(gain=0.1, seed=None)

        dense = K.layers.Dense(32, activation='relu', name='dense1', kernel_initializer=init_1)(state)
        dense = K.layers.Dense(32, activation='relu', name='dense2', kernel_initializer=init_2)(dense)
