...
class DoubleBipedalWalker(gym.Env, EzPickle):
    ...
    def __init__(self):
        ...
        high = np.array([np.inf] * 48).astype(np.float32)
    ...
    def step(self, action):
        ...
        return np.array(state+state, dtype=np.float32), reward, done, {}, {}
...
class BipedalWalkerHardcore(DoubleBipedalWalker):
    hardcore = True
