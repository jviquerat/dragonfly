...
class base_agent():
    ...
    def store_act_dim(self):
        return self.spaces.store_act_dim()
...
class base_agent_on_policy(base_agent):
    ...
    def create_buffers(self):
        ...
        self.lsizes = [self.obs_dim(), self.obs_dim(), self.store_act_dim(), 1, 1, 1]
        self.buff   = buff(self.n_cpu, self.lnames, self.lsizes)

        self.gnames = ["obs", "act", "adv", "tgt", "lgp"]
        self.gsizes = [self.obs_dim(), self.store_act_dim(), 1, 1, 1]
...
class base_agent_off_policy(base_agent):
    ...
    def create_buffers(self):
        ...
        self.sizes = [self.obs_dim(), self.obs_dim(), self.store_act_dim(), 1, 1]
