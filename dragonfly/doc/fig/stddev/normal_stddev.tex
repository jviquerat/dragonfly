...
\begin{subfigure}[t]{.35\textwidth}
	...
	\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
		...
		\begin{axis}[	xmin=0, xmax=100000, scale=0.7,
			...
			\addplot[draw=green1, thick, smooth] 		table[x index=0,y index=5] {fig/stddev/normal_stddev_log_pendulum.dat}; 
...
\begin{subfigure}[t]{.35\textwidth}
	...
	\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
		...
		\begin{axis}[	xmin=0, xmax=1000000, scale=0.7,
			...
			\addplot [fill=green3, opacity=0.5, forget plot] 	fill between[of=upper and lower];
			\addplot[draw=green1, thick, smooth] 		table[x index=0,y index=5] {fig/stddev/normal_stddev_log_lunarlander.dat}; 
...
\begin{subfigure}[t]{.35\textwidth}
	...
	\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
		...
		\begin{axis}[	xmin=0, xmax=1000000, scale=0.7,
			...
			\addplot [fill=green3, opacity=0.5, forget plot] 	fill between[of=upper and lower];
			\addplot[draw=green1, thick, smooth] 		table[x index=0,y index=5] {fig/stddev/normal_stddev_log_bipedalwalker.dat}; 
...
\begin{subfigure}[t]{.35\textwidth}
	...
	\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
		...
		\begin{axis}[	xmin=0, xmax=1000000, scale=0.7,
			...
			\addplot [fill=green3, opacity=0.5, forget plot] 	fill between[of=upper and lower];
			\addplot[draw=green1, thick, smooth] 		table[x index=0,y index=5] {fig/stddev/normal_stddev_log_hopper.dat}; 
...
\begin{subfigure}[t]{.35\textwidth}
	...
	\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
		...
		\begin{axis}[	xmin=0, xmax=1000000, scale=0.7,
			...
			\addplot [fill=green3, opacity=0.5, forget plot] 	fill between[of=upper and lower];
			\addplot[draw=green1, thick, smooth] 		table[x index=0,y index=5] {fig/stddev/normal_stddev_log_ant.dat}; 
...
\begin{subfigure}[t]{.35\textwidth}
	...
	\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
		...
		\begin{axis}[	xmin=0, xmax=1000000, scale=0.7,
			...
			\addplot [fill=green3, opacity=0.5, forget plot] 	fill between[of=upper and lower];
			\addplot[draw=green1, thick, smooth] 		table[x index=0,y index=5] {fig/stddev/normal_stddev_log_halfcheetah.dat}; 
