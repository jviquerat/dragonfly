...
\begin{subfigure}[t]{.3\textwidth}
	...
	\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
		...
		\begin{axis}[	xmin=0, xmax=100000, scale=0.7,
			...
			\addplot [upper, forget plot] 				table[x index=0,y index=7] {fig/stddev/normal_stddev_regular_pendulum.dat};
			\addplot [lower, forget plot] 				table[x index=0,y index=6] {fig/stddev/normal_stddev_regular_pendulum.dat}; 
			\addplot [fill=gray3, opacity=0.5, forget plot] 	fill between[of=upper and lower];
			\addplot[draw=gray1, thick, smooth] 			table[x index=0,y index=5] {fig/stddev/normal_stddev_regular_pendulum.dat};
...
\begin{subfigure}[t]{.3\textwidth}
	...
	\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
		...
		\begin{axis}[	xmin=0, xmax=1000000, scale=0.7,
			...
			\addplot [upper, forget plot] 				table[x index=0,y index=7] {fig/stddev/normal_stddev_regular_lunarlander.dat};
			\addplot [lower, forget plot] 				table[x index=0,y index=6] {fig/stddev/normal_stddev_regular_lunarlander.dat}; 
			\addplot [fill=gray3, opacity=0.5, forget plot] 	fill between[of=upper and lower];
			\addplot[draw=gray1, thick, smooth] 			table[x index=0,y index=5] {fig/stddev/normal_stddev_regular_lunarlander.dat};
...
\begin{subfigure}[t]{.3\textwidth}
	...
	\begin{tikzpicture}[	trim axis left, trim axis right, font=\scriptsize,
		...
		\begin{axis}[	xmin=0, xmax=1000000, scale=0.7,
			...
			\addplot [upper, forget plot] 				table[x index=0,y index=7] {fig/stddev/normal_stddev_regular_bipedalwalker.dat};
			\addplot [lower, forget plot] 				table[x index=0,y index=6] {fig/stddev/normal_stddev_regular_bipedalwalker.dat}; 
			\addplot [fill=gray3, opacity=0.5, forget plot] 	fill between[of=upper and lower];
			\addplot[draw=gray1, thick, smooth] 			table[x index=0,y index=5] {fig/stddev/normal_stddev_regular_bipedalwalker.dat};
