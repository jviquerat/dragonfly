...
We see in figure \ref{fig:ppo_entropy} that the fine-tuning of this parameter can be extremely important. Conversely, some cases are almost insensitive to it.

\input{fig/experiments/entropy}
...
We compare performance on the \ppo algorithm with and without the use of bootstrapping in figure \ref{fig:bootstrap}. Overall, bootstrapping provides a nice performance boost on \codeinline{halfcheetah}, but not particularly on \codeinline{walker2d}.

\input{fig/experiments/bootstrap}
...
\input{fig/experiments/initialization}
...
%\input{fig/experiments/architectures}
...
%
%\input{fig/convolution/1d/conv1d}
%
