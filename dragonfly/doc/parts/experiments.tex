...
We compare performance on the \ppo algorithm with and without the use of bootstrapping in figure \ref{fig:bootstrap}, using different types of returns. Overall, bootstrapping provides a nice performance boost on \codeinline{bipedalwalker-v3}, while it does not change much on \codeinline{lunarlandercontinuous-v2}. The performance gain is clearly visible on \mujoco environments (tested here only with \gae).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\textsc{d2rl} vs \textsc{mlp}}
